/* esm.sh - react-dom@19.1.1 */
import * as __0$ from "https://cdn.nav.no/okonomi/sokos-shared-dependencies/packages/react/19.1.1/react.mjs";
var require = (n) => {
  ...
  if ((e && typeof e == "object") || typeof e == "function")
    for (let a of T(e))
      !N.call(r, a) &&
        ...
        l(r, a, {
          get: () => e[a],
          enumerable: !(c = E(e, a)) || c.enumerable,
        });
  return r;
};
var D = (r, e, t) => (
  ...
  A(
    e || !r || !r.__esModule
      ? l(t, "default", { value: r, enumerable: !0 })
      : t,
    r
  )
);
